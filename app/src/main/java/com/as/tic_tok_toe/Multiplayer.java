...
public class Multiplayer extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().
            getReferenceFromUrl("https://tictactoe-d8cae-default-rtdb.firebaseio.com/");
    ...
    // values must be matching or waiting. When a user create a new connection/room and he is waiting for
    // other to join then the value will be waiting.
    private String status = "matching";
    // player turn
    private String playerTurn = "";
    // connection id in which player has joined to play the game
    private String connectionId = "";
    // connection id generated by the player
