    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, int playerTurn) {
        ...
        if (checkPlayerWin(playerTurn)) {
            ...
            if (playerTurn == 1) {
                ...
                // show win dialog
                winDialog = new WinDialogActivity(LocalModeActivity.this, "You won the game");
            } else {

                // show win dialog
                winDialog = new WinDialogActivity(LocalModeActivity.this, "Opponent won the game");
            }
        ...
        if (doneBoxes.size() == 9) {
            ...
            final WinDialogActivity winDialog = new WinDialogActivity(LocalModeActivity.this, "It is a Draw!");
            winDialog.setCancelable(false);
            winDialog.show();
        }
    }
