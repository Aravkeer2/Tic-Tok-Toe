    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, int playerTurn) {
        ...
        if (checkPlayerWin(playerTurn)) {
            ...
            if (playerTurn == 1) {
                ...
                // show win dialog
                winDialog = new WinDialog(SingleMode.this, "You won the game");
            } else {

                // show win dialog
                winDialog = new WinDialog(SingleMode.this, "Computer won the game");
            }
        ...
        if (doneBoxes.size() == 9) {
            ...
            final WinDialog winDialog = new WinDialog(SingleMode.this, "It is a Draw!");
            winDialog.setCancelable(false);
            winDialog.show();
        }
    }
